final class RouteNames {
  ...
  static const publisherPath = '/publisher';

  static const admin = 'admin';
  static const adminPath = '/admin';

  static const performanceDev = 'performance_dev';
  static const performanceDevPath = '/dev/performance';

  static const postsCreate = 'posts_create';
  static const postsCreatePath = '/posts/create';
